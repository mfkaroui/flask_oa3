...
class PathItem(Component):
    ...
    get: Annotated[
        Optional[Operation],
        Field(
            default=None, description="A definition of a GET operation on this path."
        ),
    ]
    put: Annotated[
        Optional[Operation],
        Field(
            default=None, description="A definition of a PUT operation on this path."
        ),
    ]
    post: Annotated[
        Optional[Operation],
        Field(
            default=None, description="A definition of a POST operation on this path."
        ),
    ]
    delete: Annotated[
        Optional[Operation],
        Field(
            default=None, description="A definition of a DELETE operation on this path."
        ),
    ]
    options: Annotated[
        Optional[Operation],
    ...
    head: Annotated[
        Optional[Operation],
        Field(
            default=None, description="A definition of a HEAD operation on this path."
        ),
    ]
    patch: Annotated[
        Optional[Operation],
        Field(
            default=None, description="A definition of a PATCH operation on this path."
        ),
    ]
    trace: Annotated[
        Optional[Operation],
        Field(
            default=None, description="A definition of a TRACE operation on this path."
        ),
    ]
    servers: Annotated[
    ...
    parameters: Annotated[
        Optional[List[Union[Parameter, Reference[Parameter]]]],
        Field(
            default=None,
        ...
        for param in parameters:
            if isinstance(param, Parameter):
                ...
                if identifier in seen:
                    raise ValueError(
                        "Duplicate Parameter: A unique parameter is defined by a combination of a name and location"
                    )
                seen.add(identifier)
        return parameters
