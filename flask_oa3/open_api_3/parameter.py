...
class Parameter(Component):
    ...
    name: Annotated[str, Field(default=None, description="REQUIRED. The name of the parameter. Parameter names are case sensitive.")]
    in_location: Annotated[Optional[ParameterLocation], Field(default=None, alias="in", description="REQUIRED. The location of the parameter. Possible values are \"query\", \"header\", \"path\" or \"cookie\".")]
    description: Annotated[Optional[str], Field(default=None, description="A brief description of the parameter. This could contain examples of use. CommonMark syntax MAY be used for rich text representation.")]
    required: Annotated[Optional[str], Field(default=None, description="Determines whether this parameter is mandatory. If the parameter location is \"path\", this property is REQUIRED and its value MUST be true. Otherwise, the property MAY be included and its default value is false.")]
    deprecated: Annotated[Optional[str], Field(default=None, description="Specifies that a parameter is deprecated and SHOULD be transitioned out of usage. Default value is false.")]
    style: Annotated[Optional[ParameterStyle], Field(default=None, description="Describes how the parameter value will be serialized depending on the type of the parameter value. Default values (based on value of in): for query - form; for path - simple; for header - simple; for cookie - form.")]
    explode: Annotated[Optional[bool], Field(default=None, description="When this is true, parameter values of type array or object generate separate parameters for each value of the array or key-value pair of the map. For other types of parameters this property has no effect. When style is form, the default value is true. For all other styles, the default value is false.")]
    ...
    schema: Annotated[Optional[Schema], Field(default=None, description="The schema defining the type used for the parameter.")]
    examples: Annotated[Optional[Dict[str, Union[Example, Reference[Example]]]], Field(default=None, description="Examples of the parameter’s potential value. Each example SHOULD contain a value in the correct format as specified in the parameter encoding. The examples field is mutually exclusive of the example field. Furthermore, if referencing a schema that contains an example, the examples value SHALL override the example provided by the schema.")]
