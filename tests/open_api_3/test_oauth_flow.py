...
class TestOAuthFlow:
    ...
    def test_oauth_flow_specification_extensions(self, oauth_flow_specification_extensions_fixture):
    ...
    def test_oauth_flow_oa3_schema(self, oauth_flow_implicit_fixture, oauth_flow_password_fixture, oauth_flow_client_credentials_fixture, oauth_flow_authorization_code_fixture):
