...
class TestSchema:
    ...
    def test_schema_with_discriminator_no_iterable_fail(
        self, schema_class_fixture, discriminator_fixture
    ):
        with pytest.raises(TypeError):
            Schema(
                schema_model=schema_class_fixture, discriminator=discriminator_fixture
            )

    def test_schema_with_discriminator_bad_property_name_fail(
        self,
        schema_class_fixture,
        reference_schema_fixture,
        schema_class_with_dict_fixture,
    ):
        with pytest.raises(KeyError):
            Schema(
                schema_model=[schema_class_fixture, schema_class_with_dict_fixture],
                discriminator=Discriminator(property_name="bad_property"),
            )
        with pytest.raises(KeyError):
            Schema(
                schema_model=(schema_class_fixture, schema_class_with_dict_fixture),
        ...
        with pytest.raises(KeyError):
            Schema(
                schema_model=(reference_schema_fixture, schema_class_with_dict_fixture),
                discriminator=Discriminator(property_name="bad_property"),
            )
    ...
    def test_schema_python_inheritance_component_name(
        self, schema_class_python_inheritance_fixture
    ):
    ...
    def test_schema_oa3_composition_schema_component_name(
        self, schema_class_fixture, schema_class_with_dict_fixture
    ):
        test_schema = Schema(
            schema_model=[schema_class_fixture, schema_class_with_dict_fixture]
        )
    ...
    def test_schema_oa3_composition_with_ref_schema_component_name(
        self, reference_schema_fixture, schema_class_with_dict_fixture
    ):
        test_schema = Schema(
            schema_model=[reference_schema_fixture, schema_class_with_dict_fixture]
        )
    ...
    def test_schema_oa3_union_schema_component_name(
        self, schema_class_fixture, schema_class_with_dict_fixture
    ):
        test_schema = Schema(
            schema_model=(schema_class_fixture, schema_class_with_dict_fixture)
    ...
    def test_schema_oa3_union_with_ref_schema_component_name(
        self, reference_schema_fixture, schema_class_with_dict_fixture
    ):
        test_schema = Schema(
            schema_model=(reference_schema_fixture, schema_class_with_dict_fixture)
    ...
    def test_schema_specification_extensions_oa3_schema(
        self, schema_with_specification_extensions_fixture
    ):
        expected_schema: dict = {
            "properties": {
                "int_field": {
        ...
        assert (
            schema_with_specification_extensions_fixture.oa3_schema == expected_schema
        )

    def test_schema_python_inheritance_oa3_schema(
        self, schema_class_python_inheritance_fixture
    ):
        expected_schema: dict = {
            "properties": {
            ...
            "required": ["int_field", "str_field", "bool_field"],
    ...
    def test_schema_oa3_composition_schema_oa3_schema(
        self, schema_class_fixture, schema_class_with_dict_fixture
    ):
        expected_schema: dict = {
            "allOf": [
    ...
    def test_schema_oa3_composition_with_ref_schema_oa3_schema(
        self, reference_schema_fixture, schema_class_with_dict_fixture
    ):
        expected_schema: dict = {
            "allOf": [
                {"$ref": "#/components/schemas/TestSchema", "title": "ref.TestSchema"},
                {
                    "properties": {
                        "test_discriminator": {
                            "anyOf": [{"const": "dict"}, {"const": "list"}],
    ...
    def test_schema_oa3_union_schema_oa3_schema(
        self, schema_class_fixture, schema_class_with_dict_fixture
    ):
        expected_schema: dict = {
            "oneOf": [
    ...
    def test_schema_oa3_union_with_ref_schema_oa3_schema(
        self, reference_schema_fixture, schema_class_with_dict_fixture
    ):
        expected_schema: dict = {
            "oneOf": [
    ...
    def test_schema_oa3_union_schema_with_discriminator_oa3_schema(
        self, schema_class_with_list_fixture, schema_class_with_dict_fixture
    ):
        expected_schema: dict = {
            "discriminator": {"propertyName": "test_discriminator"},
            "oneOf": [
                {
                    "properties": {
                        "test_discriminator": {
        ...
        test_schema = Schema(
            schema_model=(
                schema_class_with_list_fixture,
                schema_class_with_dict_fixture,
            ),
            discriminator=Discriminator(property_name="test_discriminator"),
        )
        assert test_schema.oa3_schema == expected_schema
        test_schema = Schema(
            schema_model=[
    ...
    def test_schema_oa3_union_schema_with_reference_discriminator_oa3_schema(
        self, schema_class_with_list_fixture, schema_class_with_dict_fixture
    ):
        expected_schema: dict = {
            "discriminator": {"propertyName": "test_discriminator"},
        ...
        test_schema = Schema(
            schema_model=(
                schema_class_with_list_fixture,
                Reference[Schema](
                    component=Schema(schema_model=schema_class_with_dict_fixture)
                ),
            ),
            discriminator=Discriminator(property_name="test_discriminator"),
        )
    ...
    def test_schema_with_reference_of_reference_has_property(
        self, reference_schema_fixture
    ):
        test_schema = Schema(schema_model=reference_schema_fixture)
    ...
    def test_schema_with_nested_field_oa3_schema(self, schema_class_with_nested_model):
        expected_schema = {
            "properties": {
                "nested_field": {"$ref": "#/components/schemas/TestSchema"},
                "list_field": {
                    "description": "A list field",
                    "items": {"type": "string"},
                    "title": "List Field",
            ...
            "required": ["nested_field", "list_field"],
    ...
    def test_schema_oa3_composition_with_nested_field_oa3_schema(
        self, schema_class_with_nested_model, schema_class_with_dict_fixture
    ):
        expected_schema = {
            "allOf": [
                {
        ...
        test_schema = Schema(
            schema_model=[
                schema_class_with_nested_model,
                schema_class_with_dict_fixture,
            ]
        )
        assert test_schema.oa3_schema == expected_schema
...
class TestDiscriminator:
    ...
    def test_discriminator_specification_extensions(
        self, discriminator_specification_extensions_fixture
    ):
        expected_schema: dict = {
        ...
        assert (
            discriminator_specification_extensions_fixture.oa3_schema == expected_schema
        )

    def test_discriminator_oa3_schema(self, discriminator_fixture):
        assert discriminator_fixture.oa3_schema == {"propertyName": "test_property"}
